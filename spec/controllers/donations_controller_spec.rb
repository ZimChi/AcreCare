...
describe DonationsController do
  ...
  let(:valid_attributes) { { "donor_firstname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved donation as @donation" do
        ...
        post :create, {:donation => { "donor_firstname" => "invalid value" }}, valid_session
        assigns(:donation).should be_a_new(Donation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested donation" do
        ...
        Donation.any_instance.should_receive(:update_attributes).with({ "donor_firstname" => "MyString" })
        put :update, {:id => donation.to_param, :donation => { "donor_firstname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the donation as @donation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Donation.any_instance.stub(:save).and_return(false)
        put :update, {:id => donation.to_param, :donation => { "donor_firstname" => "invalid value" }}, valid_session
        assigns(:donation).should eq(donation)
      end
